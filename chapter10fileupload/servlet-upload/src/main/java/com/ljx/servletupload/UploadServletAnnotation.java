...
@WebServlet(name = "uploadServletAnnotation",value = "/servletannotaion/upload")
@MultipartConfig(
        location = "/usr/local/filetemp",
        maxRequestSize = 500*1024,
        maxFileSize = 100*1024,
        fileSizeThreshold = 1000*1024/2
)
public class UploadServletAnnotation extends HttpServlet {
